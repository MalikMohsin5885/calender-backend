...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    google_calendar_id = models.CharField(max_length=255, blank=True, null=True, default="primary")
    ...
    def save_google_tokens(self, access_token, refresh_token, expires_in):
